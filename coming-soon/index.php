...
<div class="main" style="background-image: url('images/nebula1920.jpg')">
...
<!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
        ...
        <div class="content">
            <h4 class="motto">You should never worry about failure. You only have to be right once</h4>
            <div class="subscribe">
                <h5 class="info-text">
                    Join the waiting list. We will keep you posted.
                </h5>
                <div class="row">
                    <div class="col-md-4 col-md-offset-4 col-sm6-6 col-sm-offset-3 ">
												<form class="form-inline" role="form" name="contactform" method="post" action="php/contact.php">
                          <div class="form-group">
                            <input type="email" name="email" class="form-control transparent" placeholder="Your email here...">
                          </div>
                          <button type="submit" value="submit" class="btn btn-danger btn-fill"><a href="index.php">Notify Me</a></button>
                        </form>
                    </div>
                </div>
            </div>
